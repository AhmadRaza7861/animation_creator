...
List<BrushPreset> get kDefaultBrushPresets => <BrushPreset>[
  ...
  BrushPreset(
    ...
    create: () => PencilLine(density: 12, opacity: 0.75, spread: 1.0, speck: 0.09),
  ),
  BrushPreset(
    id: 'pencilH',
    name: 'Hard Pencil (H)',
    ...
    icon: Icons.edit_outlined,
    create: () => PencilLine(density: 9, opacity: 0.5, spread: 0.9, speck: 0.08),
  ),
  BrushPreset(
    id: 'pencilHB',
  ...
  BrushPreset(
    ...
    icon: Icons.edit_outlined,
    create: () => PencilLine(density: 16, opacity: 0.95, spread: 1.15, speck: 0.11),
  ),
  BrushPreset(
    id: 'grain',
    name: 'Speckled Grain',
    ...
    icon: Icons.grain,
    create: () => PencilLine(density: 18, opacity: 0.6, spread: 1.3, speck: 0.08),
  ),
  BrushPreset(
    id: 'sand',
    name: 'Desert Sand',
