  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Video import', style: TextStyle(color: Colors.black87, fontWeight: FontWeight.bold, fontSize: 18)),
        centerTitle: false,
        actions: [
          TextButton(
            onPressed: _onConfirm,
            child: const Text('Confirm', style: TextStyle(color: Colors.black87, fontWeight: FontWeight.bold)),
          ),
        ],
      ),
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                IconButton(icon: const Icon(Icons.skip_previous, size: 28), color: Colors.black87, onPressed: () {
                  _controller.seekTo(Duration(milliseconds: _startValue.toInt()));
                }),
                IconButton(icon: const Icon(Icons.fast_rewind, size: 28), color: Colors.black87, onPressed: () {
                ...
                IconButton(icon: const Icon(Icons.fast_forward, size: 28), color: Colors.black87, onPressed: () {
                  _controller.seekTo(Duration(milliseconds: (_controller.value.position.inMilliseconds + 1000).clamp(_startValue.toInt(), _endValue.toInt())));
                }),
                IconButton(icon: const Icon(Icons.skip_next, size: 28), color: Colors.black87, onPressed: () {
